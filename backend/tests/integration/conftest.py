...
BACKEND_DIR = Path(__file__).resolve().parents[2]  # поднялись из tests/integration -> tests -> backend
...
get_connection = importlib.import_module("app.database").get_connection
